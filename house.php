...
<body class="container">
    ...
    <nav >
        <ul class="nav-menu">
            ...
            <li><a href="house.php" class="selected">Дома</a></li>
        ...
        <div class="work">
            ...
            <div class="tabs">
                ...
                <section id="content-tab1">
                    ...
                    <div class="flexcheck">
                        <input type="radio" name="object" id="house"><label for="house" class="extra">Дом</label>
                        <input type="radio" name="object" id="parthouse"><label for="parthouse" class="extra">Часть дома</label>
                        <input type="radio" name="object" id="summerhouse"><label for="summerhouse" class="extra">Дача</label>
                        <input type="radio" name="object" id="area"><label for="area" class="extra">Участок</label>
                    </div>
                    <div class="flexcheck">
                ...
                <section id="content-tab2">
                    ...
                    <div class="flex">
                        ...
                        <div class="form">
                            <label for="level">Этажность:</label>
                            <input id="level" placeholder="Введите этажность">
                        </div>
                        <div class="form">
                    ...
                    <div class="flex">
                        <div class="form">
                            <label for="SquereSNB">Площадь участка:</label>
                            <input id="SquereSNB" placeholder="Введитете полощадь в м2">
                        </div>
                        <div class="form">
                            <label for="SquereSNB">Площадь дома по СНБ:</label>
                            <input id="SquereSNB" placeholder="Введитете полощадь в м2">
                        </div>
                        <div class="form">
                ...
                <section id="content-tab3">
                    ...
                    <div class="flexcheck">
                        <input type="checkbox" id="extra1"><label for="extra1" class="extra">+Гараж</label>
                        <input type="checkbox" id="extra2"><label for="extra2" class="extra">+Подвал</label>
                        <input type="checkbox" id="extra3"><label for="extra3" class="extra">+Забор</label>
                        ...
                        <input type="checkbox" id="extra6"><label for="extra6" class="extra">+Канализация</label>
                        <input type="checkbox" id="extra7"><label for="extra7" class="extra">+Водоснабжение</label>
                        <input type="checkbox" id="extra8"><label for="extra8" class="extra">+Газоснабжение</label>
                        <input type="checkbox" id="extra9"><label for="extra9" class="extra">+Электричество</label>
                    </div>
